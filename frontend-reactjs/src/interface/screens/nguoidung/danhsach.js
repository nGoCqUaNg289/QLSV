                      ...
                      {danhsach.map((item, index) => {
                        return <tr key={index} >
                          ...
                          <td>
                            ...
                            <button onClick={() => this._handleConfirmApprove(item._id.$oid || item._id, item)} title="Phê duyệt tài khoản" className="btn btn-sm btn-outline-success border-radius" style={{ display: item.KichHoat ? 'none' : 'inline' }}>
