            ...
            return (
                <React.Fragment>
                    <div className="main portlet fade-in">
                        <BreadCrumbs title={"Danh sách sinh viên"} route={[{ label: 'Quản lý sinh viên', value: '/ql-sinh-vien' }]} />
                                        ...
                                        <tbody>
                                            {danhsach.map((item, index) => {
                                                return <tr key={index} >
                                                    ...
                                                    <td>
                                                        <Link to={'/quan-ly/ql-sinh-vien/' + item._id.$oid || item._id} title="Chi tiết" className="btn btn-sm btn-outline-info border-radius"><i className="fas fa-pencil-alt" /></Link>
